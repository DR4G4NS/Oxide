...
Wire/save certification for the documented scope lives in `compat/159.7/certification-ledger.json` (`overall=PASS`, `CERTIFIED_RUNTIME_SHA` = `393dce44…`). That does **not** mean the entire Java game is ported.
...
Certificación de wire/save del scope documentado: ledger `compat/159.7/certification-ledger.json` (`overall=PASS`, `CERTIFIED_RUNTIME_SHA` = `393dce44…`). Eso **no** significa “todo el juego Java está portado”.
