...
pub(crate) const UNIT_BLOCK_SPAWN_PACKET_ID: u8 = 146;
...
pub(crate) const ASSEMBLER_DRONE_SPAWNED_PACKET_ID: u8 = 8;
pub(crate) const AUTO_DOOR_TOGGLE_PACKET_ID: u8 = 10;
pub(crate) const SET_RULES_PACKET_ID: u8 = 119;
pub(crate) const SET_FLAG_PACKET_ID: u8 = 105;
pub(crate) const SET_FLOOR_PACKET_ID: u8 = 106;
pub(crate) const SET_ITEM_PACKET_ID: u8 = 109;
pub(crate) const SET_ITEMS_PACKET_ID: u8 = 110;
pub(crate) const SET_LIQUID_PACKET_ID: u8 = 111;
pub(crate) const SET_LIQUIDS_PACKET_ID: u8 = 112;
pub(crate) const SET_MAP_AREA_PACKET_ID: u8 = 113;
pub(crate) const SET_OBJECTIVES_PACKET_ID: u8 = 114;
pub(crate) const SET_OVERLAY_PACKET_ID: u8 = 115;
pub(crate) const SET_TEAM_PACKET_ID: u8 = 120;
pub(crate) const SET_TEAMS_PACKET_ID: u8 = 121;
pub(crate) const SET_TILE_PACKET_ID: u8 = 122;
pub(crate) const SYNC_VARIABLE_PACKET_ID: u8 = 134;
pub(crate) const LOGIC_EXPLOSION_PACKET_ID: u8 = 69;
pub(crate) const CLEAR_ITEMS_PACKET_ID: u8 = 17;
pub(crate) const CLEAR_LIQUIDS_PACKET_ID: u8 = 18;
pub(crate) const CLEAR_OBJECTIVES_PACKET_ID: u8 = 19;
pub(crate) const COMPLETE_OBJECTIVE_PACKET_ID: u8 = 31;
pub(crate) const CREATE_WEATHER_PACKET_ID: u8 = 38;
pub(crate) const RESEARCHED_PACKET_ID: u8 = 94;
pub(crate) const SECTOR_CAPTURE_PACKET_ID: u8 = 96;
pub(crate) const UPDATE_GAME_OVER_PACKET_ID: u8 = 159;
...
/// `UnitEntityLegacyBeta` / `UnitEntityLegacyGamma` classIds (compat/159.7/entities.json).
